              ...
              <div className="relative w-full mt-12 space-y-0">
                  ...
                  <div className="bg-[#0f0f0f] border border-lime-green/40 shadow-[0_8px_40px_rgba(212,255,63,0.08)] rotate-[-0.6deg] group-hover:rotate-0 transition-transform duration-500 overflow-hidden">
                    ...
                    <div className="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
                      ...
                      <div className="lg:col-span-3 flex flex-col gap-2">
                        ...
                        <a href="#" className="mt-auto border border-lime-green/50 text-lime-green hover:bg-lime-green hover:text-black font-mono text-[9px] py-2 text-center transition-colors uppercase tracking-wider hidden">
                          OPEN_CASE_FILE ↗
                        </a>
                      </div>
                    </div>
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-12 gap-0 mt-8 md:mt-0 md:-mt-6">
                  ...
                  <div className="col-span-1 md:col-span-6 relative group" style={{zIndex:20}}>
                    ...
                    <div className="bg-[#09090c] border border-blue-500/30 shadow-[6px_6px_30px_rgba(48,79,254,0.15)] rotate-[1.2deg] group-hover:rotate-0 transition-transform duration-500 overflow-hidden">
                      {/* Stamp */}
                  ...
                  <div className="col-span-1 md:col-span-6 relative group mt-8 md:mt-12" style={{zIndex:15}}>
                    ...
                    <div className="bg-[#111] border border-white/15 shadow-[0_6px_30px_rgba(0,0,0,0.5)] -rotate-[1.2deg] group-hover:rotate-0 transition-transform duration-500 overflow-hidden">
                      ...
                      <div className="px-5 py-4 border-b border-white/8">
                        ...
                        <h3 className="font-syne font-black text-2xl md:text-3xl text-white uppercase leading-none">FACE<span className="text-lime-green">AFFECT</span></h3>
